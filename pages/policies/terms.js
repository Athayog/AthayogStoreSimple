...
function Terms(props) {
  return (
    <Box bg="gray.50">
      <Box maxW="container.xl" margin="auto" py={20} px={5}>
        <Head>
        ...
        <VStack spacing={10} mt={5}>
          <Box width="100%" fontWeight="light" fontSize="lg">
            ...
            <Text mb={5} fontSize="xl">
              This website is operated by <strong>Athayog Living</strong>.
              Throughout the site, the terms “we”, “us” and “our” refer to
              <strong> Athayog Living</strong>. <strong>Athayog Living</strong>{" "}
          ...
          <Box width="100%" fontWeight="light" fontSize="lg">
            ...
            <Text mb={5} fontSize="xl">
              ...
              <strong>Athayog Living</strong> and our parent, subsidiaries,
          ...
          <Box width="100%" fontWeight="light" fontSize="lg">
            ...
            <Text mb={5} fontSize="xl">
              ...
              accordance with the laws of India and jurisdiction of Banglore,
              Karnataka
            </Text>
          </Box>
          <Box width="100%" fontWeight="light" fontSize="lg">
