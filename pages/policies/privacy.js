        ...
        <VStack spacing={10} mt={5}>
          <Box width="100%" fontWeight="light" fontSize="lg">
            ...
            <Text mb={5} fontSize="xl">
              When you purchase sevice from our firm, as part of the buying and
          ...
          <Box width="100%" fontWeight="light" fontSize="lg">
            ...
            <Text mb={5} fontSize="xl">
              ...
              or mailing us at:{" "}
              <strong style={{ fontWeight: "500" }}>
                307, Athayog living, Sun Rise Arcade, Devasandra Main Road,
                Kodigehalli, Krishnarajapura, Bengaluru, Karnataka 560036
              </strong>
            </Text>
          </Box>
          <Box width="100%" fontWeight="light" fontSize="lg">
